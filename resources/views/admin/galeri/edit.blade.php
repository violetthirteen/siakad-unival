...
@section('title', 'Edit Foto - SIAKAD Unival')

@section('content')
<div class="page-header">
    <div><h1>Edit Foto</h1><p>Ubah data foto galeri</p></div>
    <a href="{{ route('admin.galeri.index') }}" class="btn-modern btn-ghost"><i class="bi bi-arrow-left"></i> Kembali</a>
</div>
<div class="card-modern">
    <div class="card-modern-body">
        <form method="POST" action="{{ route('admin.galeri.update', $galeri) }}" enctype="multipart/form-data" class="form-modern">
            @csrf @method('PUT')
            <div class="row">
                <div class="col-md-6">
                ...
                <div class="col-12">
                    ...
                    <textarea name="deskripsi" class="form-control @error('deskripsi') is-invalid @enderror" rows="3">{{ old('deskripsi', $galeri->deskripsi) }}</textarea>
