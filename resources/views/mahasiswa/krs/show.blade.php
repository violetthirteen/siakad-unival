...
<div class="page-header">
    <div>
        <h1>Detail KRS</h1>
        <p>Detail Kartu Rencana Studi</p>
    </div>
...
<div class="card-modern mb-4">
    <div class="card-modern-body">
        <div class="detail-grid">
            ...
            <div class="detail-item">
                <div class="detail-item-label">Tanggal Dibuat</div>
                <div class="detail-item-value">{{ $krs->tanggal_dibuat->format('d/m/Y') }}</div>
            </div>
            <div class="detail-item">
...
<div class="card-modern">
    <div class="card-modern-header">
        ...
        @if($krs->status == 'draft')
        <form method="POST" action="{{ route('mahasiswa.krs.add-matkul', $krs) }}" style="display:flex;gap:0.5rem;align-items:center;">
            @csrf
            ...
            <table class="table-modern">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        @if($krs->status == 'draft')
                        <td>
                            <form method="POST" action="{{ route('mahasiswa.krs.remove-matkul', $d) }}" onsubmit="return confirm('Hapus MK dari KRS?')">
                                @csrf @method('DELETE')
